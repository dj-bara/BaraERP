		...
		<div class="container max-w-6xl mx-auto">
			...
			<div class="flex flex-col justify-between pt-8 mt-8 border-t border-gray-200 md:flex-row">
				<div class="text-sm text-gray-600">
					Copyright © <a href="https://barasuite.hu/" class="text-primary-500" target="_blank">Barasuite solution</a>
				</div>

				<div class="mt-2 text-sm text-gray-600 md:mt-0">
					Powered by : <a href="https://barasuite.hu/" class="text-primary-500" target="_blank">Barasuite</a>
				</div>
			</div>
		</div>
  </footer>
